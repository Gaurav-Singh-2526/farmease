    ...
    <section className={styles.hero}>
      ...
      {images.map((img, i) => (
        <img
          key={i}
          src={img}
          className={`${styles.bg} ${index === i ? styles.active : ""}`}
          alt=""
        />
      ))}
      ...
      <div className={styles.content}>
        <p className={styles.badge}>🚜 Trusted by Farmers</p>
        ...
        <p className={styles.desc}>
          Book tractor tools in seconds. Reliable, affordable & modern.
        </p>

        <div className={styles.actions}>
          <button className={styles.primary}>Get Started</button>
          <button className={styles.secondary}>Browse Tools</button>
        </div>
      </div>
